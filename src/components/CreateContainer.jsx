    ...
    <div className="w-full min-h-screen h-auto flex items-center justify-center">
      <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2 ">
          <MdFastfood className="tex-xl text-gray-700" />
          <input
            type="text"
            required
            value={title}
              ...
              {!imageAsset ? (
                ...
                <>
                  <div className="relative h-full">
                    <img src={imageAsset} alt="uploaded_image" className="w-full h-full object-cover" />
                    <button
                      type="button"
        ...
        <div className="flex items-center w-full">
          <button type="button" className="ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-emerald-500 px-12 py-2 rounded-lg text-white font-semibold" onClick={saveDetails}>Save</button>
        </div>
      </div>
    </div>
  );
