...
const CreateContainer = () => {
  ...
  const saveDetails = () => {
    setIsLoading(true);
    try {
      if (!title || !calories || !imageAsset || !categories) {
        setFields(true);
...
//https://console.firebase.google.com/u/0/project/food-delivery-app-f9048/storage/food-delivery-app-f9048.appspot.com/files
